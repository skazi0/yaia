...
var YaiaApp = angular.module('YaiaApp', ['ngAnimate', 'ui.router', 'ui.router.title', 'ui.gravatar', 'yaia.home', 'yaia.login', 'yaia.invoices', 'yaia.welcome', 'restangular', 'yaia.auth', 'yaia.customers', 'yaia.profile']);
